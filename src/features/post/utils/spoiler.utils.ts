...
export const SPOILER_CLASSES = {
  ...
  overlay:
    "absolute inset-0 bg-black/20 backdrop-blur-md flex items-center justify-center",
  button:
    "px-4 py-2 bg-default-900/80 text-white rounded-lg hover:bg-default-900 transition-colors",
} as const;
...
export const SpoilerUtils = {
   ...
   */
  getButtonText: (isRevealed: boolean, config: SpoilerConfig = {}): string => {
    const {
