...
export function SettingsForm() {
  ...
  const onSubmit = (values: TypeSettingsSchema) => {
    ...
    toast.promise(updateAsync({ values: fd }), {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-small text-default-500">
                Управляйте основной информацией, безопасностью и оформлением
              </p>
            </div>
          </div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        avatarFile = f;
                        if (f)
                          toast.info(tToasts("fileSelected"), {
                            description: f.name,
                          });
                      }}
                    />
              ...
              <div className="flex items-center justify-between border-small rounded-medium p-3">
                <div>
                  ...
                  <p className="text-tiny text-default-500">
                    Включите второй фактор для дополнительной защиты
                  </p>
                </div>
                <Controller
                  control={form.control}
