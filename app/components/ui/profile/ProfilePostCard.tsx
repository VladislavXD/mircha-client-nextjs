...
import { useLikePostMutation, useUnLikePostMutation } from "@/src/services/post/likes.service";
    ...
    <NextCard shadow="sm" className="border border-default-100">
      ...
      <CardBody className="py-0">
        ...
        <div className="flex items-center gap-5 text-default-500 text-xs mt-3">
          <button onClick={handleLike} className="flex items-center gap-1 hover:text-primary transition-colors" disabled={likeLoading || unlikeLoading}>
