          ...
          <CardBody className="pt-0">
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Новых тредов сегодня</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Новых ответов сегодня</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Активных бордов</span>
              ...
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600">Общий размер медиа</span>
        ...
        <CardBody>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            >
              ...
              <p className="text-sm font-medium text-primary-700">Управление пользователями</p>
            </motion.button>
            ...
            >
              ...
              <p className="text-sm font-medium text-secondary-700">Управление бордами</p>
            </motion.button>
            ...
            >
              ...
              <p className="text-sm font-medium text-success-700">Модерация контента</p>
            </motion.button>
            ...
            >
              ...
              <p className="text-sm font-medium text-warning-700">Управление медиа</p>
            </motion.button>
          </div>
        </CardBody>
      </Card>
