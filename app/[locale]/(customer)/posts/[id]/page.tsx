...
//   return {
//     title: "Пост | Mirchan",
//     description: "Читайте посты на Mirchan",
//     openGraph: {
//       title: "Пост | Mirchan",
//       type: "article",
//       url: `${siteUrl}/posts/${postId}`,
...
// TODO: проверить работу метаданных в проде. в случае чего доработать их, добавив более подробные данные о посте (описание, медиа и т.д.) для улучшения SEO и отображения в соцсетях при шаринге ссылки на пост.
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  try {
    const res = await fetch(`${siteUrl}/api/posts/${postId}/meta`, {
      next: { revalidate: 60 },
    });
